...
namespace KubeClient.Models
{
    ...
    public partial class PolicyRuleV1Alpha1
    {
        ...
        public virtual List<string> ApiGroups { get; set; } = new List<string>();
        ...
        public virtual List<string> NonResourceURLs { get; set; } = new List<string>();
        ...
        public virtual List<string> ResourceNames { get; set; } = new List<string>();
