...
namespace KubeClient.Models
{
    ...
    [KubeApi("apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets", KubeAction.Create, KubeAction.DeleteCollection)]
    [KubeApi("apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}", KubeAction.Delete)]
