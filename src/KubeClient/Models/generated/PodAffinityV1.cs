...
namespace KubeClient.Models
{
    ...
    public partial class PodAffinityV1
    {
        ...
        public virtual List<WeightedPodAffinityTermV1> PreferredDuringSchedulingIgnoredDuringExecution { get; set; } = new List<WeightedPodAffinityTermV1>();
        ...
        public virtual List<PodAffinityTermV1> RequiredDuringSchedulingIgnoredDuringExecution { get; set; } = new List<PodAffinityTermV1>();
    }
}
