...
namespace KubeClient.Models
{
    ...
    [KubeApi("api/v1/watch/namespaces/{namespace}/podtemplates", KubeAction.WatchList)]
    [KubeApi("api/v1/watch/namespaces/{namespace}/podtemplates/{name}", KubeAction.Watch)]
    [KubeApi("api/v1/namespaces/{namespace}/podtemplates", KubeAction.Create, KubeAction.DeleteCollection, KubeAction.List)]
