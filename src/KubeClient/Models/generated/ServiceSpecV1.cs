...
namespace KubeClient.Models
{
    ...
    public partial class ServiceSpecV1
    {
        ...
        public virtual List<string> ExternalIPs { get; set; } = new List<string>();
        ...
        public virtual List<string> LoadBalancerSourceRanges { get; set; } = new List<string>();
        ...
        public virtual List<ServicePortV1> Ports { get; set; } = new List<ServicePortV1>();
        ...
        public virtual int HealthCheckNodePort { get; set; }
        ...
        public virtual string ExternalTrafficPolicy { get; set; }
