...
namespace KubeClient.Models
{
    ...
    public partial class ContainerV1
    {
        ...
        public virtual LifecycleV1 Lifecycle { get; set; }
        ...
        public virtual ProbeV1 LivenessProbe { get; set; }
        ...
        public virtual ProbeV1 ReadinessProbe { get; set; }
        ...
        public virtual List<EnvFromSourceV1> EnvFrom { get; set; } = new List<EnvFromSourceV1>();
        ...
        public virtual List<string> Args { get; set; } = new List<string>();
        ...
        public virtual List<ContainerPortV1> Ports { get; set; } = new List<ContainerPortV1>();
        ...
        public virtual List<VolumeMountV1> VolumeMounts { get; set; } = new List<VolumeMountV1>();
        ...
        public virtual SecurityContextV1 SecurityContext { get; set; }
        ...
        public virtual List<EnvVarV1> Env { get; set; } = new List<EnvVarV1>();
