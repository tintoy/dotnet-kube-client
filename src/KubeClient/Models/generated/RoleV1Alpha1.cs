...
namespace KubeClient.Models
{
    ...
    [KubeApi("apis/rbac.authorization.k8s.io/v1alpha1/watch/namespaces/{namespace}/roles", KubeAction.WatchList)]
    [KubeApi("apis/rbac.authorization.k8s.io/v1alpha1/watch/namespaces/{namespace}/roles/{name}", KubeAction.Watch)]
    [KubeApi("apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles", KubeAction.Create, KubeAction.DeleteCollection, KubeAction.List)]
