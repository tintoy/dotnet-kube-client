...
namespace KubeClient.Models
{
    ...
    public partial class IngressSpecV1Beta1
    {
        ...
        public virtual List<IngressRuleV1Beta1> Rules { get; set; } = new List<IngressRuleV1Beta1>();
        ...
        public virtual List<IngressTLSV1Beta1> Tls { get; set; } = new List<IngressTLSV1Beta1>();
    }
}
