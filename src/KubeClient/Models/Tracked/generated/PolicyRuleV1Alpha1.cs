...
namespace KubeClient.Models.Tracked
{
    ...
    /// </summary>
    public partial class PolicyRuleV1Alpha1 : Models.PolicyRuleV1Alpha1, ITracked
    {
        /// <summary>
        ...
        public override List<string> ApiGroups { get; set; } = new List<string>();
        ...
        public override List<string> NonResourceURLs { get; set; } = new List<string>();
        ...
        public override List<string> ResourceNames { get; set; } = new List<string>();
        ...
        public override List<string> Resources { get; set; } = new List<string>();
