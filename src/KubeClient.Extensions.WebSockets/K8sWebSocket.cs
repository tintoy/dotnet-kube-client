...
namespace KubeClient.Extensions.WebSockets
{
    ...
    /// </summary>
    public static class K8sWebSocket
    {
        /// <summary>
        ...
        /// </param>
        /// <param name="options">
        ///     <see cref="K8sWebSocketOptions"/> that control the WebSocket's configuration and connection process.
        /// </param>
        ...
        static async Task<Socket> ConnectSocketAsync(string host, int port, CancellationToken cancellationToken)
        {
        ...
        private static byte[] BuildRequestHeader(Uri uri, K8sWebSocketOptions options, string secKey)
        {
